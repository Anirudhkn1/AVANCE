...
// Verbatim from React Bits (DavidHDev/react-bits, Backgrounds/AeroShards),
// JS+CSS variant — only the "use client" directive above was added for
// Next.js App Router compatibility. See aero-shards-background.tsx for the
// app-specific wrapper (WebGPU-unsupported fallback, brand colors).
